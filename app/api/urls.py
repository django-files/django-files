...
urlpatterns = [
    ...
    path('random/album/<int:user_album>/', views.random_album, name='random-album'),
    path('random/album/<int:user_album>/<path:idname>/', views.random_album, name='random-user-album'),
