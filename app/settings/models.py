...
class SiteSettings(models.Model):
    ...
    site_description = models.TextField(
        ...
        default=(
            "A Feature Packed Self-Hosted Django/Docker File Manager for "
    ...
    default_user_storage_quota = models.PositiveBigIntegerField(
        default=0, help_text="Default storage capacity for new users in bytes."
    )
    global_storage_quota = models.PositiveBigIntegerField(
        default=0, help_text="Total storage capacity for entire django files deployment in bytes."
    )
    global_storage_usage = models.PositiveBigIntegerField(
        default=0, help_text="Current global storage usage in bytes."
    )
